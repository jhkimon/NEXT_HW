...
const author_guard_1 = require("../common/guard/author.guard");
...
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard, author_guard_1.AuthorGuard),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
